...
The team instructed a few attendees on how to build Apache Tomcat from source either from q git-checkout or from a release package. Also gave instructions for forking on GitHub for future hackingi and pull-requests.
